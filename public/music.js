...
/** 
CV values for different scales
*/
export const SCALE_CV_VALUES = {
    'major': [0.0, 0.1667, 0.3333, 0.4167, 0.5833, 0.75, 0.9167],
    'natural minor': [0.0, 0.1667, 0.25, 0.4167, 0.5833, 0.6667, 0.8333],
    'harmonic minor': [0.0, 0.1667, 0.25, 0.4167, 0.5833, 0.6667, 0.9167],
    'major pentatonic': [0.0, 0.1667, 0.3333, 0.5833, 0.75],
    'minor pentatonic': [0.0, 0.25, 0.4167, 0.5833, 0.8333],
    'blues': [0.0, 0.25, 0.4167, 0.5, 0.5833, 0.8333],
    'chromatic': [0.0, 0.0833, 0.1667, 0.25, 0.3333, 0.4167, 0.5, 0.5833, 0.6667, 0.75, 0.8333, 0.9167],
}
